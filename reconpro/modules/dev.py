...
def _check_hardcoded_secrets(base: str) -> List[Finding]:
    ...
    secret_patterns = [
        ...
        (r'(?i)aws_access_key_id\s*[:=]\s*["\']((?:AKIA|ASIA)[A-Za-z0-9]{16})', "Hardcoded AWS Access Key"),
        (r'(?i)aws_secret_access_key\s*[:=]\s*["\']([\w/+=]{40})', "Hardcoded AWS Secret Key"),
        (r'(?:AKIA|ASIA)[0-9A-Z]{16}', "Hardcoded AWS Access Key"),
        (r'ghp_[A-Za-z0-9]{36}', "Hardcoded GitHub PAT"),
        (r'gh[ousr]_[A-Za-z0-9]{36,45}', "Hardcoded GitHub token"),
        (r'github_pat_[A-Za-z0-9_]{22,}', "Hardcoded GitHub fine-grained PAT"),
        (r'glpat-[\w\-]{20,}', "Hardcoded GitLab PAT"),
        (r'xox[bposa]-[\w\-]{10,}', "Hardcoded Slack token"),
        (r'np\.[\w]{36}', "Hardcoded npm token"),
        (r'sk-(?:proj-)?[A-Za-z0-9_\-]{40,}', "Hardcoded OpenAI API key"),
        (r'sk-ant-[A-Za-z0-9_\-]{20,}', "Hardcoded Anthropic API key"),
        (r'AIza[0-9A-Za-z\-_]{35}', "Hardcoded Google API key"),
        (r'sk_live_[0-9a-zA-Z]{24,}', "Hardcoded Stripe live key"),
